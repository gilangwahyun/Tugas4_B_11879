...
st.set_page_config(
    page_title="11879 Unsupervised Learning",
    page_icon="d",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - Gilang</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_directory = r'C:\Users\lenovo\OneDrive\Documents\Tugas4_B_11879'
    model_paths = {
